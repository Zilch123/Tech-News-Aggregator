...
function createContextScope3(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      ...
      return (0, import_jsx_runtime9.jsx)(Context.Provider, { value, children });
    }
    function useContext22(consumerName, scope) {
      const Context = (scope == null ? void 0 : scope[scopeName][index2]) || BaseContext;
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? React22.useLayoutEffect : React22.useEffect;
...
var SelectContentImpl = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleItemLeave = React31.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    ...
    return (0, import_jsx_runtime13.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime13.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, children: (0, import_jsx_runtime13.jsx)(
          FocusScope,
          {
            asChild: true,
...
var BubbleSelect = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(VisuallyHidden, { asChild: true, children: (0, import_jsx_runtime13.jsx)("select", { ...selectProps, ref: composedRefs, defaultValue: value }) });
  }
);
